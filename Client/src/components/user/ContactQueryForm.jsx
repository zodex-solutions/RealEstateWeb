...
const ContactQueryForm = () => {
  const [formData, setFormData] = useState({
    ...
    bedroom: [],
    investment_reason: [],
    live_in_uae: false, // must be boolean
    resident_uae: false, // must be boolean
  ...
  const handlePropertyTypeChange = (e) => {
    ...
    setFormData((prev) => {
      const updatedTypes = checked
        ...
        : prev.property_type.filter((type) => type !== value);
      return { ...prev, property_type: updatedTypes };
    });
  };
    ...
    <section>
      <div className="w-full max-w-[597px bg-white p-6 rounded-lg shadow-lg">
        ...
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
          ...
          <div>
            <label className=" text-[15px] ">Nationality :</label>
            <div className="relative">
              <input
                type="text"
                name="nationality"
                ...
                required
              />
              <i className="fas fa-globe absolute left-3 top-1/2 transform -translate-y-1/2 text-[#2F5FA7]"></i>
            </div>
          </div>
          <div>
          ...
          <div className="space-y-4 ">
            <div>
              <label className="font text-[15px]">Property Type :</label>
              <div className="space-y-2 !mt-2 ml-3">
                {["Apartments", "Townhouses", "Villas"].map((type) => (
            ...
            <div>
              <label className="font text-[15px]">Bedroom :</label>
              <div className="space-y-2 !mt-2 ml-3">
                {[
                  "Studio",
                  "1 Bedroom",
                  ...
                  >
                    <input
                      ...
                      className="form-checkbox"
                      value={option}
                      checked={formData.bedroom.includes(option)}
                      onChange={(e) => handleCheckboxChange(e, "bedroom")}
                    />
                    {option}
                  </label>
                ))}
            ...
            <div>
              <label className="font text-[15px]">Investment Reason :</label>
              <div className="space-y-2 !mt-2 ml-3">
                {["Self Living", "Investment"].map((option) => (
                  <label
                    key={option}
                    className="flex items-center gap-2 text-sm"
                  >
                    <input
                      ...
                      className="form-checkbox"
                      value={option}
                      checked={formData.investment_reason.includes(option)}
                      onChange={(e) =>
                        handleCheckboxChange(e, "investment_reason")
                      }
                    />
                    {option}
                  </label>
            ...
            <div>
              <label className="font text-[15px]">
                Do you live in United Arab Emirates:
              </label>
              <div className="space-y-2 !mt-2 ml-3">
                <label className="flex items-center gap-2 text-sm">
                  <input
                    ...
                    name="live_in_uae"
                    value="true"
                    checked={formData.live_in_uae === true}
                    onChange={(e) => handleRadioChange(e, "live_in_uae")}
                ...
                <label className="flex items-center gap-2 text-sm">
                  <input
                    ...
                    name="live_in_uae"
                    value="false"
                    checked={formData.live_in_uae === false}
                    onChange={(e) => handleRadioChange(e, "live_in_uae")}
                    className="form-radio"
                  />
                  No
              ...
              <div className="space-y-2 !mt-2 ml-3">
                <label className="flex items-center gap-2 text-sm">
                  <input
                    ...
                    name="resident_uae"
                    value="true"
                    checked={formData.resident_uae === true}
                    onChange={(e) => handleRadioChange(e, "resident_uae")}
                    className="form-radio"
                  />
                  Yes, I have United Arab Emirates Residence Visa
                </label>
                <label className="flex items-center gap-2 text-sm">
                  <input
                    type="radio"
                    name="resident_uae"
                    value="false"
                    checked={formData.resident_uae === false}
                    onChange={(e) => handleRadioChange(e, "resident_uae")}
                    className="form-radio"
                  />
                  No, I don't have United Arab Emirates Residence Visa
                </label>
              </div>
            </div>
          </div>
